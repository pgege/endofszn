...
export interface ProductQuickview03Product {
  name: string
  price: string
  imageSrc: string
  imageAlt: string
...
export interface ProductQuickview03Props {
  product: ProductQuickview03Product
  open?: boolean
...
export function ProductQuickview03({
  product,
  open,
  onOpenChange,
  selectedColor,
                ...
                <div className="mt-3 grid grid-cols-3 gap-3 sm:grid-cols-4">
                  {product.sizes.map((size) => (
                    <button
                      ...
                      className={cn(
                        "rounded-lg border px-4 py-4 text-base font-medium transition-colors",
                        size.inStock
