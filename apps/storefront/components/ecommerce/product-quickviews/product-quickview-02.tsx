...
export interface ProductQuickview02Product {
  name: string
  price: string
  imageSrc: string
  imageAlt: string
...
export interface ProductQuickview02Props {
  product: ProductQuickview02Product
  open?: boolean
...
export function ProductQuickview02({
  product,
  open,
  onOpenChange,
  selectedColor,
        ...
        >
          ...
          <div className="flex flex-1 flex-col p-6">
            ...
            {product.href && (
              <a
                href={product.href}
                className="mt-4 text-center text-sm font-medium text-primary hover:text-primary/80"
              >
                View full details
              </a>
            )}
